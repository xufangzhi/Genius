...
# coding=utf-8
'''
SimPO tuning script. Adapted from our finetuning script.
'''
...
from simpo_utils import simpo_loss, concatenated_forward, DataCollatorForSeq2SeqDPO
...
def main():
    ...
    # no need to load the reference model
        ...
        for step, batch in enumerate(active_dataloader):
            ...
            with accelerator.accumulate(model):
                ...
                losses, _, _ = simpo_loss(
                    policy_chosen_logps, policy_rejected_logps, beta=args.beta)
